...
public static class L
{
    ...
    private static readonly Dictionary<string, Tr> _text = new(StringComparer.Ordinal)
    {
        ...
        ["寬長最大值"] = new("Max Long Edge", "長辺の最大値", "긴 변 최대값", "长边最大值", "Max. lange Kante", "Bord long max.", "Lado largo máx."),
        ...
        ["移除於預覽列"] = new("Remove from Preview", "プレビューから除外", "미리보기에서 제거", "从预览列移除", "Aus der Vorschau entfernen", "Retirer de l'aperçu", "Quitar de la vista previa"),
        ...
        ["已從預覽移除"] = new("Removed from preview", "プレビューから除外しました", "미리보기에서 제거했습니다", "已从预览移除", "Aus der Vorschau entfernt", "Retiré de l'aperçu", "Quitado de la vista previa"),
