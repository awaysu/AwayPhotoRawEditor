...
public sealed class HistogramControl : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        PaintHelpers.FillRounded(g, new RectangleF(0.5f, 0.5f, Width - 1, Height - 1), 4, Theme.ViewerBg);
        ...
        if (_hist is null) { PaintHelpers.DrawRounded(g, new RectangleF(0.5f, 0.5f, Width - 1, Height - 1), 4, Theme.Border); return; }
        ...
        PaintHelpers.DrawRounded(g, new RectangleF(0.5f, 0.5f, Width - 1, Height - 1), 4, Theme.Border);
    }
